...
function Round:draw()
	...
	font:printOutLine("Commands:", 40, box, "left", "top", EasyLD.color:new(255,255,255), EasyLD.color:new(2,0,8), 1)
	box:translate(-50, 100)
	font:printOutLine("Click to use Bonus (Boost, ...)", 40, box, "left", "top", EasyLD.color:new(255,255,255), EasyLD.color:new(2,0,8), 1)
	box:translate(-25, 50)
	font:printOutLine("Mouse: move your purple ball", 40, box, "left", "top", EasyLD.color:new(255,255,255), EasyLD.color:new(2,0,8), 1)
	box:translate(-50, 100)
	font:printOutLine("Click to START", 50, box, "left", "top", EasyLD.color:new(255,255,255), EasyLD.color:new(2,0,8), 1)
